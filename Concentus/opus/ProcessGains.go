...
func silk_process_gains(
	...
	if psEnc.indices.signalType == TYPE_VOICED {
		...
		s_Q16 = 0 - silk_sigm_Q15(silk_RSHIFT_ROUND(psEncCtrl.LTPredCodGain_Q7-int(math.Floor(12.0*float64(int64(1)<<(7))+0.5)), 4))
	...
	OpusAssert(psEncCtrl.Lambda_Q10 < (int(math.Floor(2*float64(int64(1)<<(10)) + 0.5))))
