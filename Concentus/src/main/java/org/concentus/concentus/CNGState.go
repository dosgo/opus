...
func (c *CNGState) Reset() {
	...
	c.CNGExcBufQ14 = [SilkConstantsMAXFramelength]int32{}
	c.CNGSmthNLSFQ15 = [SilkConstantsMAXLPCorder]int16{}
	c.CNGSynthState = [SilkConstantsMAXLPCorder]int32{}
	c.CNGSmthGainQ16 = 0
	c.RandSeed = 0
	c.FSkHz = 0
}
